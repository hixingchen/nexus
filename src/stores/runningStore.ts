...
import { processApi, type RunningService } from '../services/service';
...
interface RunningStore {
  ...
  loaded: boolean;
  setRunning: (running: RunningService[]) => void;
